Shader "Custom/unityCookieBeguinner/08b_emission_map" {
    ...
    SubShader {
        Pass {
            ...
            float4 frag(vertexOutput vo) : COLOR
            {
                ...
                float4 tex_emit = tex2D(_EmitMap, vo.tex.xy * _EmitMap_ST.xy + _EmitMap_ST.zw);
                ...
                float3 light_final = UNITY_LIGHTMODEL_AMBIENT.xyz + diffuse_ref + spec_ref + rim_light + (tex_emit * _EmitStr);
